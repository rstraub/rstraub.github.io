...
So, let me help you! In an effort to prevent you from repeating my mistakes, I'll share the ten books which impacted my career the most:
...
5. [Refactoring][refactoring]: Improving the Design of Existing Code
6. [Test-Driven Development][tdd]: By Example
7. [Clean Architecture][clean_architecture]
8. [Domain-Driven Design][ddd]: Tackling Complexity in the Heart of Software
9. [Pragmatic Thinking and Learning][prag_thinking]: Refactor Your Wetware
10. [Seven Habits of Highly Effective People][seven_habits]: Powerful Lessons in Personal Change
