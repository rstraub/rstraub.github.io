...
TDD brings many [benefits](), but I prefer a different perspective, a helicopter view. [Extreme Programming]() (XP) best describes the why of TDD, in my opinion.

[Kent Beck]() defined [five values]() in [Extreme Programming Explained]() which form the foundation of everything it entails. As you will see, TDD is also built on top of that foundation.
