...
*The Red Book*. I held high expectations for this title, did it deliver? Find out in this review.

## About The Red Book 📜

[Implementing Domain-Driven Design by Vaughn Vernon](https://www.goodreads.com/book/show/15756865-implementing-domain-driven-design), dubbed *The Red Book* by the Domain-Driven Design (DDD) community, is seen as a valuable companion to the original blue book.

First thing you need to know: *this book is humongous*. Coming in at 538 pages (excluding a lengthy appendix), reading and grasping Implementing DDD will take a while. It would be time well-spent, mind you.

The book is composed of 14 chapters, roughly structured like this:
* Introduction to DDD
* Strategic Patterns
* Architecture
* Tactical Patterns
...
There is a lot to like about this book, but it's not perfect.
...
Are you new to Domain-Driven Design? Or did you read The Blue Book, and want more examples of the concepts (like me)? 
